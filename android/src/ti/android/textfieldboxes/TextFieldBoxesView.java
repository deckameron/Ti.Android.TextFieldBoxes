...
public class TextFieldBoxesView extends TiUIView {
	...
	public void processProperties(KrollDict options) {
		...
		if (options.containsKey("useDenseSpacing")) {
			textFieldBoxes.setUseDenseSpacing(options.getBoolean("useDenseSpacing"));
		}
	...
	public void setTheme(int theme) {
		...
		if (theme == TextfieldboxesModule.LIGHT_THEME) {
			...
			textFieldBoxes.setHelperTextColor(Color.parseColor("#757575"));
			...
			textFieldBoxes.setErrorColor(Color.parseColor("#f44336"));
			textFieldBoxes.setHelperTextColor(Color.parseColor("#fafafa"));
